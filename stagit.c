...
writeheader(FILE *fp, const char *title)
{
    ...
    fputs("</h1>\n", fp);
    if (cloneurl[0]) {
        fputs("<div class=\"clone\">git clone ", fp);
...
writefilestree(FILE *fp, git_tree *tree, const char *path)
{
    ...
    fputs("<table id=\"files\"><thead>\n<tr>"
            "<th><b>mode</b></th><th><b>name</b></th>"
            "<th class=\"num\" align=\"right\"><b>size</b></th>"
            "</tr>\n</thead><tbody>\n", fp);
...
main(int argc, char *argv[])
{
    ...
    fputs("<div class=\"table-container\">\n<table id=\"log\"><thead>\n<tr><th><b>date</b></th>"
            ...
            "<th><b>author</b></th><th class=\"num\" align=\"right\"><b>files</b></th>"
            "<th class=\"num\" align=\"right\"><b>+</b></th>"
            "<th class=\"num\" align=\"right\"><b>-</b></th></tr>\n</thead><tbody>\n", fp);
